...
## Contexto Grupo BECM (CLAUDE.md v2.2.0)

### Regulatorio Mexicano (§8)
Al auditar proyectos de Grupo BECM, incluir SIEMPRE:

**Ley Fintech / CNBV / UIF:**
- Verificar licencias y registros requeridos
- Validar límites KYC enforced en backend:
  - Nivel 0: $1,000 MXN | Nivel 1: $8,000 MXN | Nivel 2: $50,000 MXN | Nivel 3: Sin límite
- Reportes de operaciones inusuales (UIF)
- Retención de datos según CNBV
...
- Perfil transaccional establecido

**Validadores mexicanos (@becm/mx-validators):**
- CURP, RFC, CLABE, Código Postal, Número celular, INE/IFE

### PCI DSS v4.0 (§5)
- Patrón KEK/DEK con AES-256-GCM
- LogSanitizingInterceptor con validación Luhn
- JWT RS256 (15min access), Argon2id para passwords
- HMAC webhooks con timingSafeEqual
- Modelo AuditLog append-only con SHA-256 hash